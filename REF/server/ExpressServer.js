...
var NoCacheMiddleware_1 = require("./middlewares/NoCacheMiddleware");
var DatadogStatsdMiddleware_1 = require("./middlewares/DatadogStatsdMiddleware");
var ServiceDependenciesMiddleware_1 = require("./middlewares/ServiceDependenciesMiddleware");
var Environment_1 = require("./Environment");
var setupFeatureToggles_1 = require("./middlewares/feature-toggles/setupFeatureToggles");
/**
...
var ExpressServer = /** @class */ (function () {
    function ExpressServer(catEndpoints, requestServices) {
    ...
    ExpressServer.prototype.setupFeatureToggles = function (server) {
        setupFeatureToggles_1.applyFeatureToggles(server);
    };
    ...
    ExpressServer.prototype.setupTelemetry = function (server) {
        DatadogStatsdMiddleware_1.default.applyTo(server, Environment_1.Environment.getDatadogOptions());
    };
    ExpressServer.prototype.setupServiceDependencies = function (server) {
        var servicesMiddleware = ServiceDependenciesMiddleware_1.addServicesToRequest(this.requestServices);
    ...
    ExpressServer.prototype.configureFrontendPages = function (server) {
        ...
        server.get('/', NoCacheMiddleware_1.noCache, renderPage('index'));
    };
    ExpressServer.prototype.configureStaticAssets = function (server) {
        if (Environment_1.Environment.isProd()) {
    ...
    ExpressServer.prototype.applyWebpackDevMiddleware = function (server) {
        if (Environment_1.Environment.isLocal()) {
            ...
            server.use(webpackDevMiddleware(compiler, {
                ...
                compress: true,
                host: 'localhost',
                port: Environment_1.Environment.getPort()
            }));
    ...
    ExpressServer.prototype.prepareAssets = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!Environment_1.Environment.isLocal()) return [3 /*break*/, 1];
                        this.cssFiles = [];
                        return [3 /*break*/, 3];
                    case 1:
                        _b = (_a = JSON).parse;
    ...
    ExpressServer.prototype.configureApiEndpoints = function (server) {
        ...
        server.get('/api/cat', NoCacheMiddleware_1.noCache, this.catEndpoints.getAllCats);
        server.get('/api/statistics/cat', NoCacheMiddleware_1.noCache, strictRateLimit, this.catEndpoints.getCatsStatistics);
        server.get('/api/cat/:catId', NoCacheMiddleware_1.noCache, this.catEndpoints.getCatDetails);
    };
    ExpressServer.prototype.configureFrontendEndpoints = function (server) {
        var forbidExternalFrontends = cors({ origin: false });
        server.get('/internal/cat', forbidExternalFrontends, NoCacheMiddleware_1.noCache, this.catEndpoints.getAllCats);
    };
