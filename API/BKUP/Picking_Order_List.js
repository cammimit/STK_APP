...
const ModVer  = 'PICKING_ORDER_LIST:0.01';
...
console.log('The requested service is: ' + sType);	
		...
		const q2='SELECT * FROM s_sup_doc_h_h WHERE STATUS= ? and COUNTRY="SOUTH AFRICA" and COMPANY="FITCHEF"';
	    connection.query(q2, ['SCHEDULING',userid], (error, rows) => {
         if (error) {
