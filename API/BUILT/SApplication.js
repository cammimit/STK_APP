 ...
 */
var SApplication = /** @class */ (function () {
    function SApplication() {
    }
    SApplication.createApplication = function () {
    ...
    /* handling */
    SApplication.handleExit = function (express) {
    ...
    SApplication.shutdownProperly = function (exitCode, express) {
        Promise.resolve()
...
exports.SApplication = SApplication;
